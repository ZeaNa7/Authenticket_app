exports.id = "component---src-pages-inscription-tsx";
exports.ids = ["component---src-pages-inscription-tsx"];
exports.modules = {
...
/***/ "./src/pages/inscription.tsx?export=default":
/*!**************************************************!*\
  !*** ./src/pages/inscription.tsx?export=default ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Inscription = () => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles_global_styles__WEBPACK_IMPORTED_MODULE_1__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Wrapper, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ImageContent, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Logo, {
  src: "../images/logo.svg",
  alt: "Logo"
}), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Strong authentication of your tickets")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(BottomBar, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", {
...
const Button = (0,styled_components__WEBPACK_IMPORTED_MODULE_2__["default"])(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link).withConfig({
  displayName: "buttonBlue__Button"
})(["background-color:#19a7ce;font-size:1em;border:none;border-radius:20px;cursor:pointer;height:30px;width:250px;color:white;font-weight:bold;font-style:italic;text-align:center;justify-content:center;text-decoration:none;padding-top:10px;margin:20px"]);
const ButtonBlue = ({
  to,
  children
}) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ButtonBlue);

/***/ }),

/***/ "./src/components/buttonDarkBlue.js":
/*!******************************************!*\
  !*** ./src/components/buttonDarkBlue.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Button = (0,styled_components__WEBPACK_IMPORTED_MODULE_2__["default"])(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link).withConfig({
  displayName: "buttonDarkBlue__Button"
})(["color:white;background-color:#0c134f;font-size:1em;margin:20px;border:none;border-radius:20px;cursor:pointer;height:35px;width:150px;font-weight:bold;font-style:italic;margin-top:5px;text-decoration:none;justify-content:center;align-items:center;display:flex;"]);
const ButtonDarkBlue = ({
  to,
  children
}) => {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Button, {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ButtonDarkBlue);
...
;
//# sourceMappingURL=component---src-pages-inscription-tsx.js.map